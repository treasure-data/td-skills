...
1. **Capture the Answer Box**: Restructure the page's primary section using BLUF format (30-60 words) matching the Answer Box type (see `bluf-patterns.md` in this references directory for AB→BLUF mapping)
